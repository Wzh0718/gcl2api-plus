...
CUSTOM_FILE_PATHS = {
    ...
    "src/converter/responses_api.py",
    ...
    "src/router/antigravity/responses.py",
    "src/router/geminicli/anthropic.py",
    "src/router/geminicli/gemini.py",
    "src/router/geminicli/openai.py",
    "src/router/geminicli/responses.py",
    "src/router/vertex/__init__.py",
    "src/router/vertex/gemini.py",
    "src/router/vertex/model_list.py",
